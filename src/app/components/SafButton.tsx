  ...
  return (
    ...
    >
      ...
      <div className="content-stretch flex gap-[8px] h-[32px] items-center justify-center px-[8px] py-[4px] relative rounded-[4px] shrink-0 group" data-name="contents">
        ...
        <div className="flex flex-col font-['Clario:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#1d4b34] text-[16px] whitespace-nowrap">
